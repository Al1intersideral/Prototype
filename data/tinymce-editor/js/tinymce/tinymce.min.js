...
!(function () {
    ...
    const Qn = (e, t, n) => {
        ...
        Mo = (e, t, n, o) => ({ x: e, y: t, width: n, height: o, right: e + n, bottom: t + o }),
        Io = (e) => {
    ...
    const Ho = (e) => (t) => !!t && t.nodeType === e,
                ...
                a = X(
                    ...
                    (e, t) =>
                        ((e) => -1 !== " \f\t\v".indexOf(e))(t) || t === br
                            ? e.pcIsSpace || ("" === e.str && n) || (e.str.length === s.length - 1 && o) || ((e, t) => t < e.length && t >= 0 && is(e[t]))(s, e.str.length + 1)
        ...
        ds = (e, t) =>
            ...
            ((e) => qo(e) && "A" === e.nodeName && !e.hasAttribute("href") && (e.hasAttribute("name") || e.hasAttribute("id")))(e) ||
            cs(e),
    ...
    const fs = (e) => Tn(yn(e)).exists((e) => !oo(e)),
        ...
        ea = {
            ...
            getEncodeFunc: (e, t) => {
                ...
                return o.named && o.numeric
                    ? (e, t) =>
                          e.replace(t ? Hs : $s, (e) => (void 0 !== Ks[e] ? Ks[e] : void 0 !== n[e] ? n[e] : e.length > 1 ? "&#" + (1024 * (e.charCodeAt(0) - 55296) + (e.charCodeAt(1) - 56320) + 65536) + ";" : "&#" + e.charCodeAt(0) + ";"))
                    : o.named
                    ? t
                        ? (e, t) => Zs(e, t, n)
                        : Zs
        ...
        ua = (e = {}) => {
                ...
                d = ((e) => {
                    const { globalAttributes: t, phrasingContent: n, flowContent: o } = ((e) => {
                            ...
                            (t = "id accesskey class dir lang style tabindex title role"),
                                ...
                                "html5-strict" !== e && ((t += " xml:lang"), (o = [o, "acronym applet basefont big font strike tt"].join(" ")), (n = [n, "center dir isindex noframes"].join(" ")));
                            const r = [n, o].join(" ");
                                                ...
                                                V(ta(e, "|"), (e) => {
                                                    ...
                                                    if (a) {
                                                        ...
                                                        if (("!" === n && ((t.attributesRequired = t.attributesRequired || []), t.attributesRequired.push(i), (e.required = !0)), "-" === n))
                                                            return delete r[i], void s.splice(Pt.inArray(s, i), 1);
                                                        if (
                                                            (l &&
                                                                ("=" === l
            ...
            e.valid_elements
                ...
                T("+ol[ul|ol],+ul[ul|ol]"),
                sa({ dd: "dl", dt: "dl", li: "ul ol", td: "tr", th: "tr", tr: "tbody thead tfoot", tbody: "table", thead: "table", tfoot: "table", legend: "fieldset", area: "map", param: "video audio object" }, (e, t) => {
                ...
                parse: (t) => {
                    ...
                    if (t) {
                        ...
                        f("border", "", !0),
                            ...
                            (w = "border-style"),
                            (x = "border-color"),
                            g((C = "border-width")) && g(w) && g(x) && ((a.border = a[C] + " " + a[w] + " " + a[x]), delete a[C], delete a[w], delete a[x]),
        ...
        xa = { keyLocation: !0, layerX: !0, layerY: !0, returnValue: !0, webkitMovementX: !0, webkitMovementY: !0, keyIdentifier: !0, mozPressure: !0 },
        Ea = (e, t) => {
            const n = null != t ? t : {};
                    ...
                    r.domLoaded && "ready" === t && "complete" === e.readyState
                        ...
                        : (r.hasFocusIn ||
                          ...
                          s
                              ...
                              : ((r.events[l][t] = s = [{ func: n, scope: o }]), (s.fakeName = f), (s.capture = m), (s.nativeHandler = u), "ready" === t ? Aa(e, u, r) : Sa(e, f || t, u, m)));
            }
            return (e = s = null), n;
        }
        unbind(e, t, n) {
    ...
    const Oa = Pt.each,
        ...
        za = (e, t = {}) => {
            const n = {},
                ...
                r = {};
            let s = 0;
            const a = Is.forElement(yn(e), { contentCssCors: t.contentCssCors, referrerPolicy: t.referrerPolicy }),
                i = [],
                l = t.schema ? t.schema : ua({}),
                d = wa({ url_converter: t.url_converter, url_converter_scope: t.url_converter_scope, force_hex_color: t.force_hex_color }, t.schema),
                    ...
                    O(e, (e) => {
                        if (qo(e)) {
                            const r = yn(e),
                                ...
                                a = en(r, n),
                                i = G[n];
                            i && i.set ? i.set(r.dom, s, n) : La(r, n, s), a !== s && t.onSetAttrib && t.onSetAttrib({ attrElm: r.dom, attrName: n, attrValue: s });
                        }
                    });
                },
                ...
                k = (e, t, n) => {
                    ...
                    if (!y(o) && (Vo(o) || (qo((r = o)) && "http://www.w3.org/2000/svg" === r.namespaceURI)))
                        return n ? co(yn(o), Ma(t)) : ("float" === (t = t.replace(/-(\D)/g, (e, t) => t.toUpperCase())) && (t = "cssFloat"), o.style ? o.style[t] : void 0);
                },
                S = (e) => {
                    const t = f(e);
                    if (!t) return { w: 0, h: 0 };
    ...
    const ui = (e) => {
        ...
        pi = (e, t, n = L) => {
            ...
            return { current: () => I.from(o.current()).filter(er), next: () => r("next"), prev: () => r("prev"), prev2: () => r("prev2") };
        },
        hi = (e, t) => {
        ...
        bi = Math.round,
        vi = (e) => (e ? { left: bi(e.left), top: bi(e.top), bottom: bi(e.bottom), right: bi(e.right), width: bi(e.width), height: bi(e.height) } : { left: 0, top: 0, bottom: 0, right: 0, width: 0, height: 0 }),
    ...
    const Wi = (e, t) => {
        ...
        dl = (e, t, n) => {
            ...
            return ((e, t, n, o) => {
                ...
                return t.isCollapsed() ? { start: s, forward: a, ...i } : { start: s, end: rl(r, e, n, o, !1), forward: a, ...i };
            })(e, n, t, r);
        },
        cl = (e, t, n) => {
        ...
        pl = { value: fl, error: gl, fromOption: (e, t) => e.fold(() => gl(t), fl) },
        hl = (e) => {
            ...
            return void 0 !== e.replacement
                ? m(e.replacement)
                    ? 0 === e.start.length
                        ...
                        : pl.value({ type: "inline-command", start: "", end: e.start, cmd: "mceInsertContent", value: e.replacement })
                ...
                show: (e, c) => {
                    ...
                    if (!n(c))
                        return (
                            ...
                            Lc(a.nextSibling) ? (u.setStart(a, 0), u.setEnd(a, 0)) : (u.setStart(a, 1), u.setEnd(a, 1)),
                            u
                        );
                    {
                        const n = ((e, t, n) => {
        ...
        Vu = (e, t, n) =>
            ((e, t, n = !1) =>
                2 === t
                    ...
                    ? ((e) => {
                          const t = e.getRng();
                          return { start: tl(e.dom.getRoot(), Vi.fromRangeStart(t)), end: tl(e.dom.getRoot(), Vi.fromRangeEnd(t)), forward: e.isForward() };
                      })(e)
                    : t
                ...
                if (t) {
                    ...
                    if (((e) => m(e.start))(t))
                        return ((e, t) => {
                            ...
                            return Mt(n, o, (n, o) => {
                                const r = e.createRng();
                                return r.setStart(n.container(), n.offset()), r.setEnd(o.container(), o.offset()), { range: r, forward: Fu(t) };
                            });
                        })(n, t);
                    if (((e) => Ee(e, "id"))(t))
                        return ((e, t) => {
                            ...
                            return Mt(n, o.or(n), (n, o) => {
                                const r = e.createRng();
                                return r.setStart(Uu(e, n.container()), n.offset()), r.setEnd(Uu(e, o.container()), o.offset()), { range: r, forward: Fu(t) };
                            });
                        })(n, t);
                    if (Mu(t))
                        return ((e, t) =>
    ...
    const Xu = (e) => "" !== e && -1 !== " \f\n\r\t\v".indexOf(e),
        ...
        Um = (e, t, n, o, r, s) => {
            ...
            return l(n, o, Im)
                .bind((e) => (s ? l(e.container, e.offset + (r ? -1 : 0), Fm) : I.some(e)))
        ...
        Vm = (e, t, n, o = !1) => {
            ...
            return (
                ...
                qo(a) && a.hasChildNodes() && ((a = ki(a, t.collapsed ? i : i - 1)), er(a) && (i = a.data.length)),
                (r = Lm(e, r)),
                (a = Lm(e, a)),
                qm(r) && ((r = Om(r) ? r : r.parentNode), (r = t.collapsed ? r.previousSibling || r : r.nextSibling || r), er(r) && (s = t.collapsed ? r.length : 0)),
                qm(a) && ((a = Om(a) ? a : a.parentNode), (a = t.collapsed ? a.nextSibling || a : a.previousSibling || a), er(a) && (i = t.collapsed ? 0 : a.length)),
                t.collapsed &&
                    (Um(e, e.getRoot(), r, s, !0, o).each(({ container: e, offset: t }) => {
                        (r = e), (s = t);
                    }),
                    Um(e, e.getRoot(), a, i, !1, o).each(({ container: e, offset: t }) => {
                        (a = e), (i = t);
                    })),
                (Nm(l) || l.block_expand) && ((Nm(l) && er(r) && 0 !== s) || (r = $m(e, n, r, s, !0)), (Nm(l) && er(a) && i !== a.data.length) || (a = $m(e, n, a, i, !1))),
                Rm(l) && ((r = zm(e, n, t, r, "previousSibling")), (a = zm(e, n, t, a, "nextSibling"))),
                (km(l) || Sm(l)) && ((r = jm(e, n, r, "previousSibling")), (a = jm(e, n, a, "nextSibling")), km(l) && (e.isBlock(r) || (r = $m(e, n, r, s, !0)), e.isBlock(a) || (a = $m(e, n, a, i, !1)))),
    ...
    const Zm = (e, t, n) => !n.collapsed && $(n.getClientRects(), (n) => ((e, t, n) => t >= e.left && t <= e.right && n >= e.top && n <= e.bottom)(n, e, t)),
        ...
        df = Math.abs,
        cf = Math.round,
        uf = { nw: [0, 0, -1, -1], ne: [1, 0, 1, -1], se: [1, 1, 1, 1], sw: [0, 1, -1, 1] },
        mf = (e, t) => {
            const n = t.dom,
                o = t.getDoc(),
                r = document,
            ...
            const x = (e) => C(e) && (ir(e) || n.is(e, "figure.image")),
                ...
                A = (e) => {
                    ...
                    (o = e.screenX - u),
                        ...
                        c && (df(o) > df(r) ? ((v = cf(b * p)), (b = cf(v / p))) : ((b = cf(v / p)), (v = cf(b * p)))),
                        R(i, b, v),
                        (C = d.startPos.x + o),
                        (_ = d.startPos.y + r),
                        (C = C > 0 ? C : 0),
                                      ...
                                      h.stopImmediatePropagation(),
                                          ...
                                          ((h) => {
                                              ...
                                              (u = h.screenX),
                                                  ...
                                                  (i = E((v = a)) ? n.create("img", { src: At.transparentSrc }) : v.cloneNode(!0)),
                ...
                L = (o) => {
                    ...
                    const r = "mousedown" === o.type ? o.target : e.getNode(),
                        a = no(yn(r), "table,img,figure.image,hr,video,span.mce-preview-object,details")
                            .map((e) => e.dom)
    ...
    const bf = (e, t, n, o) => ({ start: e, soffset: t, finish: n, foffset: o }),
        vf = document.caretPositionFromPoint
            ...
            : I.none,
        yf = hl([{ before: ["element"] }, { on: ["element", "offset"] }, { after: ["element"] }]),
        Cf = { before: yf.before, on: yf.on, after: yf.after, cata: (e, t, n, o) => e.fold(t, n, o), getStart: (e) => e.fold(R, R, R) },
        ...
        xf = {
            ...
            getWin: (e) => {
                const t = ((e) => e.match({ domRange: (e) => yn(e.startContainer), relative: (e, t) => Cf.getStart(e), exact: (e, t, n, o) => e }))(e);
                return Rn(t);
            },
            range: bf,
        },
            ...
            return ((e, t) => {
                const n = ((e, t) =>
                    t.match({
                        ...
                        exact: (t, n, o, r) => ({ ltr: De(() => gf(e, t, n, o, r)), rtl: De(() => I.some(gf(e, o, r, t, n))) }),
                    }))(e, t);
                return ((e, t) => {
                    const n = t.ltr();
                    return n.collapsed
                        ? t
                              ...
                              .map((e) => pf.rtl(yn(e.endContainer), e.endOffset, yn(e.startContainer), e.startOffset))
            ...
            const a = ((e, t) => {
                const n = ((e, t) => {
                        ...
                        if (t < n.length && !qf(n[t])) return { element: n[t], offset: 0 };
                        {
                            ...
                            return qf(o) ? { element: e, offset: t } : "img" === Ht(o) ? { element: o, offset: 1 } : Kt(o) ? { element: o, offset: Cr(o).length } : { element: o, offset: Mn(o).length };
                        }
                    })(e, t),
    ...
    const Cg = za.DOM,
        ...
        Sg = (e, t) => {
            ((e, t) => ((e) => (e.collapsed ? I.from(ki(e.startContainer, e.startOffset)).map(yn) : I.none()))(t).bind((t) => (Nr(t) ? I.some(t) : kn(e, t) ? I.none() : I.some(e))))(yn(e.getBody()), t)
                .bind((e) => Ou(e.dom))
                .fold(
                    () => {
                    ...
                    "raw" === t.format
                        ...
                        ? ((e, t) => {
                              const n = e.getDoc(),
                                  o = qn(yn(e.getBody())),
                                  r = bn("div", n);
                              Jt(r, "data-mce-bogus", "all"), lo(r, { position: "fixed", left: "-9999999px", top: "0" }), So(r, t.innerHTML), ap(r), ip(r);
    ...
    const fp = ["font", "text-decoration", "text-emphasis"],
        ...
        Qp = (e) =>
            iu(e)
                .bind((e) => Jn(e, Wt))
                .exists((e) => ((e) => H(["pre", "pre-wrap"], e))(co(e, "white-space"))),
        Jp = (e, t) => (n) => {
            ...
            ((e, t, n) =>
                e
                    ? ((e, t) =>
                          gh(t)
                              .orThunk(() => fh(t))
                              .orThunk(() => ((e, t) => Au(e, Vi.after(t)).orThunk(() => Tu(e, Vi.before(t))))(e, t)))(t, n)
                    : ((e, t) =>
                          fh(t)
                              .orThunk(() => gh(t))
                              .orThunk(() =>
                    ...
                    return ((e) =>
                        Mt(e.startTable, e.endTable, (t, n) => {
                            const o = Lh(t, (e) => _n(e, n)),
                                r = Lh(n, (e) => _n(e, t));
                            return o || r ? { ...e, startTable: o ? I.none() : e.startTable, endTable: r ? I.none() : e.endTable, isSameTable: !1, isMultiTable: !1 } : e;
                        }).getOr(e))({ startTable: n, endTable: o, isStartInTable: r, isEndInTable: s, isSameTable: a, isMultiTable: !a && r && s });
                })(t, n);
            return ((e, t, n) =>
                e.exists(
                    (e) =>
                            ...
                            : ((e, t, n, o, r) =>
                                  Su(n, e.getBody(), r).fold(
                                      ...
                                      (s) =>
                                          ((e, t, n, o) =>
                                              Ou(e.dom)
                                                  .bind((r) => Bu(e.dom).map((e) => (t ? n.isEqual(r) && o.isEqual(e) : n.isEqual(e) && o.isEqual(r))))
                                                  .getOr(!0))(o, n, r, s)
                                              ? ((e, t) => rb(e, t))(e, o)
                                              : ((e, t, n) =>
            ...
            return e.selection.isCollapsed() && 0 === o.length
                ...
                : ((e, t, n) => {
                      ...
                      return 0 !== n.length
                          ...
                          : ((e, t, n, o) =>
                                ob(t, o).fold(
                                    () => ((e, t, n) => Yh(t, n).bind((t) => t.fold(T(eb, e), T(tb, e), T(Jh, e), T(Zh, e))))(e, t, n),
                                    (t) => ((e, t) => rb(e, t))(e, t)
                                ))(e, o, r, t);
                  })(e, n, o);
        },
        ...
        xb = (e, t, n = t.parent) =>
            !(
                ...
                ((!e.children[t.name] || e.isValidChild(n.name, t.name)) &&
                    ...
                    (!((e) => "summary" === e.name)(n) || !mb(t) || ((null == n ? void 0 : n.firstChild) === t && (null == n ? void 0 : n.lastChild) === t)))
            ),
        Eb = (e) =>
            e.collapsed
                ? e
        ...
        Rb = (e, t, n, o) => {
            ...
            return s
                ? c(1)
                    ...
                    : c(2)
                    ? ((e, t, n, o) => (o.insertAfter(t.reverse(), e), Nb(t[0], n)))(s, a, d, t)
                    : ((e, t, n, o) => {
                          const r = ((e, t) => {
            ...
            m === f &&
                ...
                s.isCollapsed() ||
                    ((e) => {
                        ...
                        ((e, t, n) => !!C(n) && n === e.getParent(t.endContainer, Tb) && rm(yn(n), t))(t, n, o)
                            ? eb(e, n, yn(o))
                            : n.startContainer === n.endContainer && n.endOffset - n.startOffset == 1 && er(n.startContainer.childNodes[n.startOffset])
                            ? n.deleteContents()
        ...
        Kb = (e, t, n) => {
            const o = e.dom,
                r = e.selection;
            if (t) Wb(e, t, n);
            else if (!(t = Lu(e.getBody(), r.getStart()))) for (; (t = o.get(Pu)); ) Wb(e, t, n);
        },
    ...
    const nv = ["fontWeight", "fontStyle", "color", "fontSize", "fontFamily"],
        ...
        Sv = (e, t, n) => (x(e) ? { name: t, value: null } : { name: e, value: vm(t, n) }),
        Nv = (e, t) => {
                    ...
                    const s = e.formatter.get(t),
                            ...
                            return ((e, t, n, o, r, s, a, i) => {
                                ...
                                if (n) {
                                    ...
                                    (a.mixed && m.isBlock(n)) || (o = null !== (l = m.split(n, o)) && void 0 !== l ? l : o),
                                        c && u && (null === (d = r.parentNode) || void 0 === d || d.insertBefore(c, r), u.appendChild(r), Nm(a) && mv(e, a, 0, c));
                                }
                                return o;
                            })(e, s, i, o, o, 0, a, n);
                        },
                        ...
                        u = (t) => {
                            ...
                            V(["underline", "line-through", "overline"], (n) => {
                                qo(t) && e.dom.getStyle(t, "text-decoration") === n && t.parentNode && xm(i, t.parentNode) === n && Bv(e, { deep: !1, exact: !0, inline: "span", styles: { textDecoration: n } }, void 0, t);
                            });
                        },
                        m = (e) => {
                            ...
                            if (t) {
                                ...
                                return (
                                    ((e) => Ku(e) && qo(e) && ("_start" === e.id || "_end" === e.id))(n) && (n = n[e ? "firstChild" : "lastChild"]),
                        ...
                        f = (t) => {
                            ...
                            if (a.split) {
                                if (((r = Ff(r)), (n = wv(e, r, !0)), (o = wv(e, r)), n !== o)) {
                                    ...
                                    (n = Ev(i, n, "span", { id: "_start", "data-mce-type": "bookmark" })), (o = Ev(i, o, "span", { id: "_end", "data-mce-type": "bookmark" }));
                                    const e = i.createRng();
                                    e.setStartAfter(n),
                                        e.setEndBefore(o),
                                        Wm(i, e, (e) => {
                    ...
                    a && Nm(s) && !em(e).length
                        ? ((e, t, n) => {
                              ...
                              if (l && i > 0 && i < l.length && d.test(l.charAt(i)) && d.test(l.charAt(i - 1))) {
                                  ...
                                  let s = o ? qb(o) : null;
                                  (o && (null == s ? void 0 : s.data) === $b) || ((c = e.getDoc()), (u = Vb(!0).dom), (o = c.importNode(u, !0)), (s = o.firstChild), a.insertNode(o), (i = 1)),
            ...
            ge(n, (n, r) => {
                const s = (n) => {
                    ...
                    if (n.state.get() !== a) {
                        n.state.set(a);
                        const e = s.getOr(t);
                        Fv(n) ? n.callback(a, { node: e, format: r, parents: o }) : V(n.callbacks, (t) => t(a, { node: e, format: r, parents: o }));
                    }
                };
                        ...
                        V(e, (e) => {
                            e.replace(
                                ((e, t, n, o, r) => {
                                    ...
                                    const a = new Wg(s, 1);
                                    return a.attr("audio" === s ? { src: t } : { src: t, width: n, height: o }), ("audio" !== s && "video" !== s) || a.attr("controls", ""), "iframe" === s && r && a.attr("sandbox", ""), a;
    ...
    var Xy = (function e() {
            ...
            _e = function (e) {
                if (!we || we !== e) {
                    if (
                        ...
                        e.FORBID_CONTENTS && (se === ae && (se = Sy(se)), ky(se, e.FORBID_CONTENTS, Ce)),
                        ne && (M["#text"] = !0),
                        ...
                        return (
                            ...
                            (e.namespaceURI === me
                                ...
                                ? t.namespaceURI === fe
                                    ...
                                    : Boolean(Ae[n])
                                : e.namespaceURI === fe
                                ? !(t.namespaceURI === me && !Se[o]) && !(t.namespaceURI === ue && !ke[o]) && !Ae[n] && (Ne[n] || !Re[n])
                                : !("application/xhtml+xml" !== ve || !he[e.namespaceURI]))
                        );
                    })(e)
                    ? (Te(e), !0)
                    : ("noscript" !== r && "noembed" !== r && "noframes" !== r) || !wy(/<\/no(script|embed|frames)/i, e.innerHTML)
                    ? (K && 3 === e.nodeType && ((t = e.textContent), (t = vy(t, R, " ")), (t = vy(t, A, " ")), (t = vy(t, T, " ")), e.textContent !== t && (gy(n.removed, { element: e.cloneNode() }), (e.textContent = t))),
            ...
            Ie = function (e, t, n) {
                ...
                if (q && !H[t] && wy(O, t));
                    ...
                    if (
                        !(
                            (Fe(e) &&
                                ((z.tagNameCheck instanceof RegExp && wy(z.tagNameCheck, e)) || (z.tagNameCheck instanceof Function && z.tagNameCheck(e))) &&
                                ((z.attributeNameCheck instanceof RegExp && wy(z.attributeNameCheck, t)) || (z.attributeNameCheck instanceof Function && z.attributeNameCheck(t)))) ||
                            ("is" === t && z.allowCustomizedBuiltInElements && ((z.tagNameCheck instanceof RegExp && wy(z.tagNameCheck, n)) || (z.tagNameCheck instanceof Function && z.tagNameCheck(n))))
                        )
                    )
                        return !1;
                } else if (de[t]);
        ...
        return (
            (n.sanitize = function (e) {
                ...
                if (oe) return e;
                if (Q) {
                    if (J) for (i = _.call(t.ownerDocument); t.firstChild; ) i.appendChild(t.firstChild);
                    else i = t;
                    return (F.shadowroot || F.shadowrootmode) && (i = S.call(o, i, !0)), i;
                }
                let u = Y ? t.outerHTML : t.innerHTML;
                return (
                    Y && M["!doctype"] && t.ownerDocument && t.ownerDocument.doctype && t.ownerDocument.doctype.name && wy(Ky, t.ownerDocument.doctype.name) && (u = "<!DOCTYPE " + t.ownerDocument.doctype.name + ">\n" + u),
        ...
        nC = (e, t, n) => {
            ...
            return (
                ...
                (!!/((java|vb)script|mhtml):/i.test(o) ||
                    (!e.allow_html_data_urls && (/^data:image\//i.test(o) ? ((e, t) => (C(e) ? !e : !C(t) || !H(tC, t)))(e.allow_svg_data_urls, n) && /^data:image\/svg\+xml/i.test(o) : /^data:/i.test(o))))
            );
        };
    class oC {
    ...
    const iC = (e, t, n, o, r) => {
            ...
            if (!d || h) {
                if ((C(r) && (r.allowedTags[u] = !0), d && h && !g)) {
                    if (
                        (V(null !== (i = h.attributesForced) && void 0 !== i ? i : [], (e) => {
                ...
                o.addHook("uponSanitizeAttribute", (o, r) => {
                    ((e, t, n, o, r) => {
                        ...
                        (r.keepAttr = lC(t, n, o, s, a, i)),
                            r.keepAttr ? ((r.allowedAttributes[a] = !0), cC(a, n) && (r.attrValue = a), t.allow_svg_data_urls && He(i, "data:image/svg+xml") && (r.forceKeepAttr = !0)) : dC(e, a) && (r.forceKeepAttr = !0);
                    })(o, e, t, n.current(), r);
                }),
                o
            );
        ...
        wC = (e, t) => {
            if (t.no_events) return pl.value(t);
            {
                const n = vC(t.content, (n) => ((e, t) => e.dispatch("BeforeSetContent", t))(e, { ...t, content: n }), { sanitize: fc(e), sandbox_iframes: Cc(e) });
        ...
        jC = (e) => {
            ...
            return ((e) => null !== e.querySelector("iframe"))(n)
                ? { type: "fragmented", fragments: Y(q(ce(n.childNodes), k(Dr, FC)), (e) => e.length > 0), content: "", bookmark: null, beforeBookmark: null }
        ...
        HC = (e, t, n) => {
            ...
            "fragmented" === t.type ? UC(t.fragments, e.getBody()) : e.setContent(t.content, { format: "raw", no_selection: !C(o) || !Iu(o) || !o.isFakeCaret }), o && (e.selection.moveToBookmark(o), e.selection.scrollIntoView());
        },
                ...
                closest: (t) =>
                    ((e, t) => {
                        ...
                        return I.from(e.selection.getStart(!0))
                            .bind((o) => Lb(yn(o), (n) => ue(t, (t) => ((t, n) => (jb(e, t.dom, n) ? I.some(n) : I.none()))(n, t)), n))
                            .getOrNull();
                    })(e, t),
                        ...
                        ((e, t, n, o, r, s) => {
                            ...
                            V(n.split(","), (t) => {
                                const n = xe(a, t).getOrThunk(() => {
                                        const e = { withSimilar: { state: $a(!1), similar: !0, callbacks: [] }, withoutSimilar: { state: $a(!1), similar: !1, callbacks: [] }, withVars: [] };
                                        return (a[t] = e), e;
                                    }),
                                    i = () => {
                                        const n = jv(e);
                                ...
                                Bb(t)
                                    ...
                                    : ((e, t, n, o) => {
                                          if (0 === (n = Dr(n)).length || /^\s+$/.test(n)) {
                                              ...
                                              const s = Il(e);
                                              return e.schema.isValidChild(t.nodeName.toLowerCase(), s.toLowerCase()) ? ((n = r), (n = e.dom.createHTML(s, Fl(e), n))) : n || (n = r), Pb(e, n, o.no_selection), { content: n, html: n };
                                          }
                                          {
                                              "raw" !== o.format && (n = up({ validate: !1 }, e.schema).serialize(e.parser.parse(n, { isRootContent: !0, insert: !0 })));
                                              const r = Ar(yn(t)) ? n : Pt.trim(n);
                                              return Pb(e, r, o.no_selection), { content: r, html: r };
                                          }
                                      })(e, o, t, n)
                            )
                            .getOr({ content: t, html: Bb(n.content) ? "" : n.content }))(e, t, n),
    ...
    const ow = (e) => !(!e || !e.ownerDocument) && kn(yn(e.ownerDocument), yn(e)),
                    ...
                    getNode: () =>
                        ((e, t) => {
                            ...
                            t.collapsed ||
                                ...
                                er(n) && er(o) && ((n = n.length === r ? Lg(n.nextSibling, !0) : n.parentNode), (o = 0 === s ? Lg(o.previousSibling, !1) : o.parentNode), n && n === o && (a = n)));
        ...
        mw = [{ name: "template", replacedWith: "Advanced Template" }, { name: "rtc" }],
        fw = (e, t) => {
                                            ...
                                            : ((o = t),
                                              He(o, "blob:")
                                                  ...
                                                  ? ((r = o),
                                                    new Promise((e, t) => {
                                                        Kv(r)
                                                            .bind(({ type: e, data: t, base64Encoded: n }) => Yv(e, t, n))
    ...
    const qw = (e, t) => {
        ...
        Vw = (e) => () => e.notificationManager.open({ text: e.translate("Image uploading..."), type: "info", timeout: -1, progressBar: !0 }),
        Ww = (e, t) => qw(t, { url: Gl(e), basePath: Xl(e), credentials: Ql(e), handler: Jl(e) }),
        Kw = (e) => {
            const t = (() => {
                let e = [];
                const t = (e) => {
                                                ...
                                                ? (n.url && !je(l.src, n.url) && (s = !0),
                                                  ...
                                                  XC(e) ||
                                                      ((t, n) => {
                                                          ...
                                                          var r;
                                                          d(t.src, n), Zt(yn(t), { src: Vl(e) ? ((r = n), r + (-1 === r.indexOf("?") ? "?" : "&") + new Date().getTime()) : n, "data-mce-src": o });
                                                      })(l, n.url))
                                                : n.error &&
                                    ...
                                    ? (p(o) || (o = [o]),
                                      V(o, (e) => {
                                          v(e.deep) && (e.deep = !Sm(e)),
                                              ...
                                              Sm(e) && Nm(e) && ((e.mixed = !0), (e.block_expand = !0)),
                    ...
                    return (
                        n(
                            ((e) => {
                                ...
                                return (
                                    Pt.each("p h1 h2 h3 h4 h5 h6 div address pre dt dd samp".split(/\s/), (e) => {
                        ...
                        n(Qw()),
                        n(Cd(e)),
                        { get: (e) => (C(e) ? t[e] : t), has: (e) => Ee(t, e), register: n, unregister: (e) => (e && t[e] && delete t[e], t) }
                    );
                })(e),
                n = $a({});
            return (
            ...
            const t = Xa(),
                ...
                r = {
                    ...
                    dispatchChange: () => {
                        e.setDirty(!0);
                        const t = jC(e);
                        (t.bookmark = ml(e.selection)), e.dispatch("change", { level: t, lastLevel: ie(r.data, o.get()).getOrUndefined() });
                    },
                        ...
                        e.on("init", () => {
                            ...
                            e.on("keyup", (n) => {
                                ...
                                ((s >= 33 && s <= 36) || (s >= 37 && s <= 40) || 45 === s || n.ctrlKey || a) && (r(), e.nodeChanged()),
                                    ...
                                    o.get() && t.typing && !VC(jC(e), t.data[0]) && (e.isDirty() || e.setDirty(!0), e.dispatch("TypingUndo"), o.set(!1), e.nodeChanged());
                            }),
                            e.on("keydown", (e) => {
                                const s = e.keyCode;
                ...
                if (gs(t)) {
                    const e = (e) => {
                            const t = (e, n) =>
                                Fn(e).fold(
                                    () => n,
                                    (e) => (((e, t) => e.isInline(Ht(t)))(o, e) ? t(e, n.concat(fi(e))) : n)
                                );
                            return t(e, []);
                        },
                        ...
                        ? ((e, t, n) => {
                                          ...
                                          mx(e, n).map((n) =>
                                              ((e, t, n) =>
                                                  ar(n.position.getNode()) && !gs(n.block)
                                                      ? Ru(!1, n.block.dom)
                                                            .bind((o) => (o.isEqual(n.position) ? ku(t, e, o).bind((t) => mx(e, t)) : I.some(n)))
                                                            .getOr(n)
                                                      : n)(e, t, n)
                                          )
                                      )
                              ...
                              return Mt(o, r, ux).filter(
                                  (t) =>
                                      ...
                                      ((e) => !1 === dr(e.from.block.dom) && !1 === dr(e.to.block.dom))(t) &&
                                      ((e) => {
        ...
        Ex = (e) => {
            ...
            return ((e, t) => {
                ...
                : ((e, t, n) => {
                      const o = t.getRng();
                      return Mt(Ah(e, yn(o.startContainer)), Ah(e, yn(o.endContainer)), (r, s) =>
                          _n(r, s)
                              ? I.none()
                              : I.some(() => {
                                    o.deleteContents(),
                            ...
                            return !t && Tp(s)
                                ...
                                : ((e, t, n, o) =>
                                      ((e, t) => {
                                          ...
                                          ? ((e, t) => (y(t) ? I.none() : e && dr(t.nextSibling) ? I.some(Dx.moveToElement(t.nextSibling)) : !e && dr(t.previousSibling) ? I.some(Dx.moveToElement(t.previousSibling)) : I.none()))(
                                                t,
                                                n.getNode(!t)
                                            ).orThunk(() => Lx(e, t, n, o))
                                          : Lx(e, t, n, o).bind((t) =>
                                                ((e, t, n) =>
                                                    n.fold(
                                                        ...
                                                        (n) => (Qc(t, n, e) ? I.none() : I.some(Dx.moveToPosition(n)))
                                                    ))(e, n, t)
                                            ))(e, t, s, o);
                        })(e.getBody(), t, e.selection.getRng(), e.schema).map((n) => () =>
                            n.fold(
                                ((e, t) => (n) => (e._selectionOverrides.hideFakeCaret(), vh(e, t, yn(n)), !0))(e, t),
                                ((e, t) => (n) => {
    ...
    const bE = (e, t) => (e === cu.Backwards ? oe(t) : t),
        ...
        CE = (e, t, n, o) => {
            ...
            for (; s; ) {
                const n = vE(t, r, s);
                if (!n) break;
                if (ar(n.getNode(!1))) return t === cu.Forwards ? { positions: bE(t, a).concat([n]), breakType: hE.Br, breakAt: I.some(n) } : { positions: bE(t, a), breakType: hE.Br, breakAt: I.some(n) };
                if (n.isVisible()) {
                    if (e(s, n)) {
                        const e = yE(0, t, s, n);
    ...
    const UE = (e, t, n, o, r, s) => {
            ...
            if (e.selection.isCollapsed() && yd(e)) {
                ...
                return ((e, t, n, o) => {
                    const r = ((e, t) => Xc(t, e) || e)(e.getBody(), o.container()),
                        ...
                        a = iE(s, r, o);
                    return a
                        .bind((e) => (n ? e.fold(N(I.some(uE(e))), I.none, N(I.some(cE(e))), I.none) : e.fold(I.none, N(I.some(cE(e))), I.none, N(I.some(uE(e))))))
                        .map(i_(e, t))
                        .getOrThunk(() => {
                            const i = Su(n, r, o),
                                l = i.bind((e) => iE(s, r, e));
        ...
        fk = (e, t, n, o, r) => {
            const s = Uo(yn(n), "td,th,caption").map((e) => e.dom),
                a = Y(
                    ((e, t) =>
                        te(t, (t) => {
                            const n = ((e, t) => ({ left: e.left - t, top: e.top - t, right: e.right + -2, bottom: e.bottom + -2, width: e.width + t, height: e.height + t }))(vi(t.getBoundingClientRect()), -1);
                            return [
        ...
        hk = (e, t, n) => {
            const o = e(t, n);
            return ((e) => e.breakType === hE.Wrap && 0 === e.positions.length)(o) || (!ar(n.getNode()) && ((e) => e.breakType === hE.Br && 1 === e.positions.length)(o))
            ...
            if (!t && bk(o, s)) {
                const o = ((e, t, n) =>
                    ((e, t) =>
                        ...
                        .orThunk(() => le(n.getClientRects()).bind((n) => xE(SE(e, Vi.before(t)), n.left)))
            ...
            if (t && vk(o, s)) {
                const o = ((e, t, n) =>
                    ((e, t) =>
                        ...
                        .orThunk(() => le(n.getClientRects()).bind((n) => xE(NE(e, Vi.after(t)), n.left)))
        ...
        Rk = (e, t) => {
            ...
            return ((e, t) => ((e, t, n = L) => (n(t) ? I.none() : H(e, Ht(t)) ? I.some(t) : eo(t, e.join(","), (e) => xn(e, "table") || n(e))))(["td", "th"], e, t))(yn(t ? s.endContainer : s.startContainer), r)
                .map(
                    (n) => (
                        ck(n, r).each((t) => {
                ...
                () =>
                    ((e, t, n, o = 0) => {
                        ...
                        return Lk(
                            ...
                            const s = Mk(r);
                            return 0 !== s.lastIndexOf(n) || Fk(s, n).length < o ? I.none() : I.some({ text: Fk(s, n), range: r, trigger: n });
                        });
                    })(e, t, n, o),
                (t) => {
                    const o = e.createRng();
                        ...
                        t.matches.getOrThunk(() =>
                            ((e) => (t) => {
                                ...
                                return !((e, t) => {
                                    ...
                                    return Lk(e, t.container, t.offset, (e, t) => (0 === t ? -1 : t), o)
                                        .filter((e) => {
    ...
    const qk = (e, t, n) => (e.stype === $k.Error ? t(e.serror) : n(e.svalue)),
        ...
        Xk = (e, t) => ({
            extract: (n, o) =>
                xe(o, e).fold(
                    () => ((e, t) => Gk(e, () => 'Choice schema did not contain choice key: "' + t + '"'))(n, e),
                    (e) =>
                        ((e, t, n, o) =>
                            xe(n, o).fold(
                                () => ((e, t, n) => Gk(e, () => 'The chosen schema: "' + n + '" did not exist in branches: ' + Yk(t)))(e, n, o),
        ...
        lS = (e, t, n) => {
            return (o = ((e, t, n) => ((e, t) => (e.stype === $k.Error ? { stype: $k.Error, serror: t(e.serror) } : e))(t.extract([e], n), (e) => ({ input: n, errors: e })))(e, t, n)), qk(o, pl.error, pl.value);
            var o;
        },
        dS = (e, t) => Xk(e, pe(t, aS)),
        cS = N(oS),
    ...
    aS([US("contextform"), NS("initValue", N("")), LS, ((e, t) => hS(e, e, { tag: "required", process: {} }, iS(t)))("commands", GS), wS("launch", dS("type", { contextformbutton: KS, contextformtogglebutton: YS }))].concat(qS));
    const XS = (e) => {
            ...
            const t = Xa(),
                ...
                a = (a) => {
                    ((n) =>
                        t
                            .get()
                            .map((t) => Uk(e.dom, e.selection.getRng(), t.trigger).bind((t) => Hk(e, s, t, n)))
                            .getOrThunk(() =>
                                ((e, t) => {
                                    const n = t(),
                                        o = e.selection.getRng();
        ...
        sN = (e, t, n) => {
            ...
            if ("character" === n) {
                ...
                return (
                    !!(l && (t ? c : d) && Su(!t, s, n).exists((e) => nN(o, e) && !Lt(i, tN(o, e)))) ||
                    Su(t, s, n).fold(L, (n) => {
                        const r = tN(o, n);
                        if (nN(o, n) && !Lt(i, r)) {
                            if ((t || rN(e, n, !1), a && l)) {
        ...
        aN = (e, t, n, o) => {
            ...
            return "selection" === o
                ...
                : n
                ? ((e, t) => t.startSummary.exists((t) => ((e, t) => Bu(t).exists((n) => (ar(n.getNode()) && Tu(t, n).exists((t) => t.isEqual(e))) || n.isEqual(e)))(e, t)))(s, t) ||
                  ((e, t, n) => n.startDetails.exists((n) => Au(e, t).forall((e) => !n.contains(e.container()))))(a, s, t)
                : ((e, t) => t.startSummary.exists((t) => ((e, t) => Ou(t).exists((t) => t.isEqual(e)))(e, t)))(s, t) ||
                  ((e, t) => t.startDetails.exists((n) => Tu(n, e).forall((n) => t.startSummary.exists((t) => !t.contains(e.container()) && t.contains(n.container())))))(s, t);
        },
        iN = (e, t, n) =>
            ((e, t, n) =>
                ((e, t) => {
        ...
        ZN = (e, t, n) => {
            t.selection.isCollapsed() ||
                ...
                (C(n) && cN(t, e.fakeEventName).isDefaultPrevented()) || (e.insert(t, n), C(n) && dN(t, e.fakeEventName));
        },
        eR = (e, t) => {
            const n = () => ZN(UN, e, t),
                o = () => ZN(ON, e, t),
        ...
        mR = (e) => {
            ...
            if (e.selection.isCollapsed()) {
                ...
                return iE(o, e.getBody(), r)
                    ...
                    .map((o) => () => ((e, t, n) => (o) => (Zp(e, o, n) ? dR(t) : cR(t)))(n, t, e.schema)(o).each(uR(e)));
            }
            return I.none();
        },
        fR = (e) => {
                                ...
                                ((e, t, n) => {
                                    ...
                                    nk(
                                        [
                                            ...
                                            ...(o
                                                ? [
                                                      { keyCode: af.UP, action: tk(G_, e, !1), metaKey: !0, shiftKey: !0 },
                                                      { keyCode: af.DOWN, action: tk(G_, e, !0), metaKey: !0, shiftKey: !0 },
                                                  ]
                                                : []),
                                            ...
                                            { keyCode: af.RIGHT, ctrlKey: !o, altKey: o, action: tk(r_, e, t) },
                                    ...
                                    ((e, t, n) => {
                                        ...
                                        ok(
                                            [
                                                ...
                                                ...(fN
                                                    ? [
                                                          { keyCode: af.BACKSPACE, altKey: !0, action: tk(iN, e, !1, a(!0)) },
                                                          { keyCode: af.DELETE, altKey: !0, action: tk(iN, e, !0, a(!0)) },
                                                          { keyCode: af.BACKSPACE, metaKey: !0, action: tk(iN, e, !1, a(!1)) },
                                                      ]
                                                    : [
                                                          { keyCode: af.BACKSPACE, ctrlKey: !0, action: tk(iN, e, !1, a(!0)) },
                                                          { keyCode: af.DELETE, ctrlKey: !0, action: tk(iN, e, !0, a(!0)) },
                                                      ]),
                                    ...
                                    ((e, t, n) => {
                                        nk(
                                            [
                                                ...
                                                ...(fN
                                                    ? [{ keyCode: af.BACKSPACE, altKey: !0, action: tk(C_, e) }, { keyCode: af.DELETE, altKey: !0, action: tk(C_, e) }, ...(n ? [{ keyCode: gN ? 224 : 91, action: tk(C_, e) }] : [])]
                                                    : [
                                                          { keyCode: af.BACKSPACE, ctrlKey: !0, action: tk(C_, e) },
                                                          { keyCode: af.DELETE, ctrlKey: !0, action: tk(C_, e) },
                                                      ]),
                                            ],
                                            t
                                        );
                        ...
                        e.on("input", (t) => {
                            t.isComposing ||
                                ((e) => {
                                    const t = yn(e.getBody());
                                    e.selection.isCollapsed() &&
                                        ih(t, Vi.fromRangeStart(e.selection.getRng()), e.schema).each((t) => {
                                            e.selection.setRng(t.toRange());
                                        });
                                })(e);
                        });
                                    ...
                                    nk(
                                        [
                                            ...
                                            ...(o
                                                ? []
                                                : [
                                                      { keyCode: af.HOME, action: tk(G_, e, !1), ctrlKey: !0, shiftKey: !0 },
    ...
    const _R = ui("mode"),
        ...
        KR = (e) =>
            WR(e, [
                ...
                [/( ?)<span class="Apple-converted-space">\u00a0<\/span>( ?)/g, (e, t, n) => (t || n ? br : " ")],
        ...
        JR = (e, t, n) =>
            !!((e, t) => XR(t) && $(pc(e), (e) => $e(t.toLowerCase(), `.${e.toLowerCase()}`)))(e, t) &&
            ((e, t, n) => (
                e.undoManager.extra(
                    () => {
                        n(e, t);
        ...
        iA = (e, t, n) => {
            ...
            if (Gd(e) && o) {
                ...
                if (s.length > 0)
                    return (
                        t.preventDefault(),
                        ((r = s), Promise.all(q(r, (e) => Gv(e).then((t) => ({ file: e, uri: t }))))).then((t) => {
    ...
    const RA = (e, t) => Math.abs(e.left - t),
        ...
        PA = (e, t, n) =>
            ((e, t, n) => {
                ...
                .filter((e) => Mc(e.node))
                .map((e) => ((e, t) => ({ node: e.node, position: RA(e, t) < AA(e, t) ? NA.Before : NA.After }))(e, t)),
        DA = (e) => {
            var t, n;
        ...
        MA = (e, t, n, o) => {
            ...
            return v(o)
                ...
                : ((e, t, n, o) => ({ ...t, dataTransfer: o, type: e, ...LA(n) }))(e, o, t, r);
        },
        IA = dr,
        FA = ((...e) => (t) => {
                    ...
                    if (e.dragging) {
                        const s = r.currentTarget === t.getDoc().documentElement,
                            l = ((e, t) => ({ pageX: t.pageX - e.relX, pageY: t.pageY + 5 }))(
                                ...
                                ((e, t) => {
                                    return (
                                        (n = ((e) => (e.inline ? DA(e.getBody()) : { left: 0, top: 0 }))(e)),
                                        (o = ((e) => {
                                            const t = e.getBody();
                            ...
                            !((e, t, n) => {
                                const o = yn(e.getBody()),
                                    ...
                                    s = ((e, t, n, o) => {
                                        ...
                                        return { x: n - (e ? r.left + t.dom.clientLeft + Aw(t) : 0), y: o - (e ? r.top + t.dom.clientTop + Rw(t) : 0) };
                                    })(e.inline, r, t, n);
                                return ((e, t, n) => {
                                    const o = Sw(e),
                                        r = Nw(e);
        ...
        nT = (e, t, n, o, r, s, a = !1) => ({ start: tT(e, t, n, o, a), end: tT(e, t, r, s, a) }),
        oT = (e, t) => {
            const n = t.slice(),
                o = n.pop();
            return x(o) ? X(n, (e, t) => e.bind((e) => I.from(e.childNodes[t])), I.some(e)).bind((e) => (er(e) && (o < 0 || o > e.data.length) ? I.none() : I.some({ node: e, offset: o }))) : I.none();
        },
        rT = (e, t) =>
        ...
        aT = (e, t, n, o = !0) => {
            ...
            t.deleteContents(),
                o &&
                    !n(t.startContainer) &&
                    (er(t.startContainer) && 0 === t.startContainer.data.length && e.remove(t.startContainer), er(t.endContainer) && 0 === t.endContainer.data.length && e.remove(t.endContainer), sT(e, r, n), r !== s && sT(e, s, n));
        },
        ...
        fT = (e, t, n) => {
            const o = rT(e.getRoot(), n).getOrDie("Unable to resolve path range"),
                ...
                l = i.parentNode;
            return { prefix: t, end: a.parentNode.insertBefore(uT(e, t + "-end"), a), start: l.insertBefore(uT(e, t + "-start"), i) };
        },
        gT = (e, t, n) => {
            ...
            return Pk(i, l - n.pattern.end.length, t).bind((d) => {
                ...
                if (pT(a)) return I.some({ matches: [{ pattern: a, startRng: c, endRng: c }], position: d });
                {
                    ...
                    return m.map((e) => {
                        ...
                        return { matches: l.matches.concat([{ pattern: a, startRng: t, endRng: c }]), position: Ak(e.startContainer, e.startOffset) };
                    });
                }
            });
        },
        ...
        CT = (e, t, n, o, r, s) => {
            ...
            return ((e, t) => {
                ...
                vT(e, ((a = r.inlinePatterns), ae(a, (e, t) => t.end.length - e.end.length)), n, o, t, s).fold(
                    () => [],
                    (e) => e.matches
                )
            );
                    ...
                    const s = Math.max(0, n.startOffset),
                        ...
                        l = ((e, t, n, o) => {
                            ...
                            return ((e, t) => {
                                ...
                                .map((e) => (Pt.trim(i).length === e.start.length ? [] : [{ pattern: e, range: nT(s, s.getRoot(), t, 0, t, 0, true) }]))
                                .getOr([]);
                        })(e, o, a);
                    return (
        ...
        PT = (e) => {
            ...
            (o.disabled = !0),
                ...
                !e.readonly && e.hasEditableRoot() && (e.inline && "static" === kT.getStyle(o, "position", !0) && (o.style.position = "relative"), (o.contentEditable = "true")),
                (o.disabled = !1),
                (e.editorUpload = Kw(e)),
                (e.schema = ua(AT(e))),
                (e.dom = za(n, {
                    ...
                    ((e) => {
                        ((e) => {
                            const t = [",", ".", ";", ":", "!", "?"],
                                n = [32],
                                o = () => {
                                    return (t = ac(e)), (n = ic(e)), { inlinePatterns: wl(t), blockPatterns: Cl(t), dynamicPatternsLookup: n };
                                    var t, n;
                                },
                ...
                ((e) => {
                    ...
                    const n = e.dom,
                        ...
                        s = (t, a) => {
                            ...
                            const i = e.getBody(),
                                l =
                                    !((e) => dx(e) && !(cx(e) || ("keyup" === e.type && 229 === e.keyCode)))(t) &&
                                    ((e, t, n) => {
                                        if (gs(yn(t), !1)) {
                ...
                return ((e) => xe(e.plugins, "rtc").bind((e) => I.from(e.setup)))(e).fold(
                    ...
                    (e) => (
                        (t.rtcInstance = (() => {
                            ...
                            return {
                                init: { bindEvents: _ },
                                undoManager: { beforeChange: _, add: e, undo: e, redo: e, clear: _, reset: _, hasUndo: L, hasRedo: L, transact: e, ignore: _, extra: _ },
                                formatter: { match: L, matchAll: N([]), matchNode: N(void 0), canApply: L, closest: t, apply: _, remove: _, toggle: _, formatChanged: N({ unbind: _ }) },
            ...
            ((e) => {
                ...
                ((e) => {
                    ...
                    Wd(e) || ((t.body.spellcheck = !1), kT.setAttrib(n, "spellcheck", "false")),
                    (e.quirks = _T(e)),
                    ((e) => {
                ...
                e.inline
                    ...
                    : ((e, t) => {
                          ((e, t) => {
                              ...
                              (r.onload = () => {
                                  ...
                                  (e.iframeHTML = ((e) => {
                                      ...
                                      const n = Pl(e),
                                          ...
                                          r = e.translate(jd(e));
                                      return (
                                          Ll(e) && (t += '<meta http-equiv="Content-Security-Policy" content="' + Ll(e) + '" />'),
                              ...
                              t.editorContainer && ((t.editorContainer.style.display = e.orgDisplay), (e.hidden = LT.isHidden(t.editorContainer))),
                ...
                ((e, t, n) => {
                    const o = HT(t, "default", n),
                        r = ((e) =>
                            I.from(Yl(e))
                                .filter(Ye)
                                .map((e) => ({ url: e, name: I.none() })))(t).orThunk(() => HT(t, Kl(t), ""));
                    V(
                        ((e) => {
                            const t = [],
                                n = (e) => {
        ...
        XT = (e, t) => ({ table_grid: !1, object_resizing: !1, resize: !1, toolbar_mode: xe(e, "toolbar_mode").getOr("scrolling"), toolbar_sticky: !1, ...(t ? { menubar: !1 } : {}) }),
        QT = (e, t) => {
            var n;
        ...
        eO = (e, t) => {
            ...
            return /^ | $/.test(t)
                ? ((e, t, n, o) => {
                      ...
                      return (
                          (n = eh(r, Vi.fromRangeStart(t), o) ? n.replace(/^ /, "&nbsp;") : n.replace(/^&nbsp;/, " ")), th(r, Vi.fromRangeEnd(t), o) ? n.replace(/(&nbsp;| )(<br( \/)>)?$/, "&nbsp;") : n.replace(/&nbsp;(<br( \/)?>)?$/, " ")
                      );
            ...
            I.from(n)
                ...
                .bind((n) =>
                    ((e, t, n) =>
                        Lb(
                            yn(n),
                            (t) => ((t) => mo(t, e).orThunk(() => (oO(t) ? xe(nO, e).bind((e) => tn(t, e)) : I.none())))(t),
                            (e) => _n(yn(t), e)
                        ))(e, t, n.dom).or(((e, t) => I.from(za.DOM.getStyle(t, e, !0)))(e, n.dom))
                )
                .getOr(""),
        sO = rO("font-size"),
    ...
    const RO = (e, t) => {
                ...
                "focus" !== e &&
                    ...
                    (n.removed ||
                        (t
                            ...
                            : n.initialized && n.delegates && (n.dom.unbind(RO(n, e), e, n.delegates[e]), delete n.delegates[e])));
            },
        ...
        BO = (e) => (m(e) ? { value: e.split(/[ ,]/), valid: !0 } : E(e, m) ? { value: e, valid: !0 } : { valid: !1, message: "The value must be a string[] or a comma/space separated string." }),
        ...
        FO = Pt.each,
        UO = Pt.explode,
        zO = { f1: 112, f2: 113, f3: 114, f4: 115, f5: 116, f6: 117, f7: 118, f8: 119, f9: 120, f10: 121, f11: 122, f12: 123 },
    ...
    class $O {
        ...
        createShortcut(e, t, n, o) {
            ...
            return (r[r.length - 1] = Pt.extend(r[r.length - 1], { func: n, scope: o || this.editor })), Pt.extend(r[0], { desc: this.editor.translate(t), subpatterns: r.slice(1) });
        }
        hasModifier(e) {
    ...
    class YO {
        constructor(e, t, n) {
            ...
            (this.options = ((e, t) => {
                ...
                ((e) => {
                    ...
                    t("id", { processor: "string", default: e.id }),
                        ...
                        t("text_patterns", {
                            processor: (e) => (E(e, f) || !1 === e ? { value: xl(!1 === e ? [] : e), valid: !0 } : { valid: !1, message: "Must be an array of objects or false." }),
                            default: [
                        ...
                        t("noneditable_regexp", { processor: (e) => (E(e, Sl) ? { value: e, valid: !0 } : Sl(e) ? { value: [e], valid: !0 } : { valid: !1, message: "Must be a RegExp or an array of RegExp." }), default: [] }),
                        ...
                        e.on("ScriptsLoaded", () => {
                            t("directionality", { processor: "string", default: Ka.isRtl() ? "rtl" : void 0 }), t("placeholder", { processor: "string", default: kl.getAttrib(e.getElement(), "placeholder") });
                        });
                })(o);
            ...
            c && (At.cacheSuffix = c.replace(/^[\?\&]+/, "")),
                (this.ui = { registry: qO(), styleSheetLoader: void 0, show: _, hide: _, setEnabled: _, isEnabled: M }),
                (this.mode = ((e) => {
                    const t = $a("design"),
                        n = $a({ design: { activate: _, deactivate: _, editorReadOnly: !1 }, readonly: { activate: _, deactivate: _, editorReadOnly: !0 } });
                    return (
                        ((e) => {
                            e.serializer
                                ? CO(e)
        ...
        render() {
            ((e) => {
                ...
                e.on("remove", () => {
                    ...
                    (e.ui.styleSheetLoader = ((e, t) => Is.forElement(e, { contentCssCors: Dd(t), referrerPolicy: ed(t) }))(o, e)),
                    kd(e) ? (e.inline = !0) : ((e.orgVisibility = e.getElement().style.visibility), (e.getElement().style.visibility = "hidden"));
                const s = e.getElement().form || zT.getParent(t, "form");
                s &&
                    ((e.formElement = s),
                    Sd(e) && !Zo(e.getElement()) && (zT.insertAfter(zT.create("input", { type: "hidden", name: t }), t), (e.hasHiddenInput = !0)),
                    ...
                    !Nd(e) || s.submit.nodeType || s.submit.length || s._mceOldSubmit || ((s._mceOldSubmit = s.submit), (s.submit = () => (e.editorManager.triggerSave(), e.setDirty(!1), s._mceOldSubmit(s))))),
        ...
        hide() {
            ...
            e.hidden ||
                (e.save(),
                e.inline ? ((e.getBody().contentEditable = "false"), e === e.editorManager.focusedEditor && (e.editorManager.focusedEditor = null)) : (VO.hide(e.getContainer()), VO.setStyle(e.id, "display", e.orgDisplay)),
                (e.hidden = !0),
                e.dispatch("hide"));
        }
        isHidden() {
        ...
        destroy(e) {
            ((e, t) => {
                ...
                e.destroyed ||
                    (t || e.removed
                        ? (t || (e.editorManager.off("beforeunload", e._beforeUnload), e.theme && e.theme.destroy && e.theme.destroy(), ww(n), ww(o)),
                          ((e) => {
                        ...
                        (i = ((e, t) => {
                            ...
                            ((e) =>
                                At.browser.isIE() || At.browser.isEdge()
                                    ? (Fw("TinyMCE does not support the browser you are using. For a list of supported browsers please see: https://www.tiny.cloud/docs/tinymce/6/support/#supportedwebbrowsers"), [])
                                    : oB
                                    ? (Fw("Failed to initialize the editor as the document is not in standards mode. TinyMCE requires standards mode."), [])
                                    : m(e.selector)
                        ...
                        0 === i.length
                            ...
                            : XO(i, (s) => {
                                  ((e, t) => e.inline && t.tagName.toLowerCase() in o)(e, s)
                                      ? Fw("Could not initialize inline editor on invalid inline target element", s)
                                      : ((e, o, s) => {
    ...
    const gB = {
            ...
            dom: { EventUtils: Ta, TreeWalker: jo, TextSeeker: hi, DOMUtils: za, ScriptLoader: Ha, RangeUtils: Uf, Serializer: iw, StyleSheetLoader: Ms, ControlSelection: mf, BookmarkManager: Jm, Selection: rw, Event: Ta.Event },
