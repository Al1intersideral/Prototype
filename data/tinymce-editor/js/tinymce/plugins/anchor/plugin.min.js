...
!(function () {
    ...
    e.add("anchor", (e) => {
        ((e) => {
                ...
                e.addCommand("mceAnchor", () => {
                    ((e) => {
                        ...
                        e.windowManager.open({
                            ...
                            initialData: { id: t },
                            onSubmit: (t) => {
                                ((e, t) => (/^[A-Za-z0-9\-:._]*$/.test(t) ? (d(e, t), !0) : (e.windowManager.alert("ID should start with a letter, followed only by letters, numbers, dashes, dots, colons or underscores."), !1)))(
                                    e,
                                    t.getData().id
                                ) && t.close();
                            },
            ...
            e.on("PreInit", () => {
                ((e) => {
                    e.formatter.register("namedAnchor", { inline: "a", selector: a, remove: "all", split: !0, deep: !0, attributes: { id: "%value" }, onmatch: (e, t, o) => l(e) });
                })(e);
            });
    });
})();
